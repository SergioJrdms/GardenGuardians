...
import { IconBrandGmail, IconChevronLeft } from "@tabler/icons-react";
                    ...
                    <div className="rounded-xl bg-white shadow-xl">
                        <div className="p-6 sm:p-16">
                            ...
                            <div className="mt-16 grid space-y-4">
                                ...
                                <button className="group h-12 px-6 border-2 border-gray-300 rounded-full transition duration-300 hover:border-palette-lightgreen">
                                    <div className="relative flex items-center space-x-4 justify-center">
                                        <svg xmlns="https://icons8.com/icon/eFPBXQop6V2m/gmail-logo.svg" fill="currentColor" className="absolute left-0 w-5 text-gray-700" viewBox="0 0 16 16">
                                            <IconBrandGmail />
                                        </svg>
                                        <span className="block w-max font-semibold tracking-wide text-gray-700 text-sm transition duration-300 group-hover:text-palette-lightgreen sm:text-base">Continue com o Gmail</span>
                                    </div>
                                </button>
                                <button className="group h-12 px-6 border-2 border-gray-300 rounded-full transition duration-300 hover:border-palette-lightgreen">
                                    <div className="relative flex items-center space-x-4 justify-center">
